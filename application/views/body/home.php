  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-6 hero-img" data-aos="zoom-out" data-aos-delay="200"> <img
          src="<?= base_url() ?>assets/img/home_x.png" style="width:100%" alt=""></div>
    </div>
  </div>
</section>
<main id="main">
    ...
    <div class="container" data-aos="fade-up">
      ...
      <div class="row">
        ...
        <div class="col-lg-6 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="400">
          <div class="box"> <img style="margin-top: -25px;" src="<?= base_url() ?>assets/img/djs_2.png" class="img-fluid" alt="">
