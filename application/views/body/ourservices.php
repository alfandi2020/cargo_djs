    ...
    <section id="services" class="values">
        <div class="container" data-aos="fade-up">
            <header class="section-header">
                <!-- <h2>Our Services</h2> -->
                <p style="text-align:justify !important;">Our Services</p>
            </header>
            <div class="row">
          ...
          <div class="col-lg-6"> <img src="<?= base_url() ?>assets/img/features-2.png" class="img-fluid" alt=""></div>
            ...
            <div class="row feature-icons" data-aos="fade-up">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-8 d-flex content">
                        <div class="row align-self-center gy-4">
                            <p style="text-align:justify !important;">Aiming to provide the best possible services to its new and existing Clients, we supplies
            ...
            <!-- <div class="row feature-icons" data-aos="fade-up">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-2 d-flex flex-row-reverse">
                        <div class="row align-self-center gy-4">
                            <p style="text-align:justify !important;">General Agent Local Agent Owner Protecting Agent Renewal Ship Documents Customs Clearance
        ...
        <div class="clients-slider swiper">
          <div class="swiper-wrapper align-items-center">
            <?php 
              ...
              for ($i=1; $i <12 ; $i++) { ?>
            <div class="swiper-slide"><img src="<?= base_url() ?>assets/img/clients/client-<?=$i?>.png" class="img-fluid"
                alt=""></div>
            <?php }
              ?>
      ...
      <div class="clients-slider swiper">
        <div class="swiper-wrapper align-items-center">
          <?php 
            ...
            for ($i=1; $i <12 ; $i++) { ?>
          <div class="swiper-slide"><img src="<?= base_url() ?>assets/img/partner<?=$i?>.png" class="img-fluid" alt="">
          </div>
          <?php }
            ?>
